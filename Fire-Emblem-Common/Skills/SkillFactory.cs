...
public static class SkillFactory
{
    ...
    private static Skill CreateSkill(string skillName, Unit unit)
    {
        ...
        if (skillName == "HP +15")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new HpPlusFifteenEffectt());
        ...
        else if (skillName == "Fair Fight")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Both, new AtkBonusEffectt(6));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Will to Win")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(8));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(unit.Atk.BaseValue / 2, AttackType.FirstAttack));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(12 + unit.Spd.BaseValue / 4));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Tome Precision")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(6));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }

        else if (skillName == "Defense +5")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }

        else if (skillName == "Wrath")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new WrathEffectt());
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Resolve")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(7));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(7));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }

        else if (skillName == "Resistance +5")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }

        else if (skillName == "Atk/Def +5")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Deadly Blade")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(8));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(8));
        ...
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(8));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(8));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Sturdy Blow")
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(6));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Mirror Strike")
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(6));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Brazen Atk/Spd")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(10));
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(10));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Brazen Atk/Def")
        {
            conditions.Add(new HpPercentageCondition(0.8, UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(10));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(10));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Brazen Atk/Res")
        {
            conditions.Add(new HpPercentageCondition(0.8, UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(10));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(10));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Chaos Style")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(3));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(4));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Not *Quite*")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(4));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Stunning Smile")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(8));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new ManRivalCondition());
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(8));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new LastOpponentCondition());
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(3));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        
        else if (skillName == "Luna")
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPercentagePenaltyEffectt(0.5, AttackType.FirstAttack));
            effectsByUnitType.AddEffect(UnitRole.Rival, new ResPercentagePenaltyEffectt(0.5, AttackType.FirstAttack));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Belief in Love")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(5));
            conditionEvaluator = new OrConditionEvaluator(conditions); 
        }
        
        else if (skillName == "Beorc's Blessing")
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Def, StatType.Res, StatType.Spd })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        
        else if (skillName == "Agnea's Arrow")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new PenaltyNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Def, StatType.Res, StatType.Spd })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new WeaponTypeCondition(UnitRole.Unit, new EnumList<WeaponType>(new List<WeaponType> { WeaponType.Sword })));
            effectsByUnitType.AddEffect(UnitRole.Rival, new AverageDefResEffectt());
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        
        else if (skillName == "Sandstorm")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new SandstormEffectt());
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new WeaponTypeCondition(UnitRole.Unit, new EnumList<WeaponType>(new List<WeaponType> { WeaponType.Sword })));
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(12));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkPenaltyEffectt(6));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Lance Power")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(10));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefPenaltyEffectt(10));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Bow Focus")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(10));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResPenaltyEffectt(10));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Lull Atk/Spd")
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Spd })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Def })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new ResPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Res })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Lull Spd/Def")
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Spd, StatType.Def })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Lull Spd/Res")
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new ResPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Spd, StatType.Res })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Lull Def/Res")
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new ResPenaltyEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Def, StatType.Res })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Fort. Def/Res")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkPenaltyEffectt(2));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Life and Death")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefPenaltyEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResPenaltyEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Rival, new ResPenaltyEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Rival, new AtkPenaltyEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(5));
            effectsByUnitType.AddEffect(UnitRole.Rival, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Def, StatType.Res, StatType.Spd })));
            effectsByUnitType.AddEffect(UnitRole.Unit, new PenaltyNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Atk, StatType.Def, StatType.Res, StatType.Spd })));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Dragon Wall")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new ComparisonPercentageReductionEffectt(0.4, StatType.Res, StatType.Res, 4));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Dodge")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new ComparisonPercentageReductionEffectt(0.4, StatType.Spd, StatType.Spd, 4));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Golden Lotus")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.5, AttackType.FirstAttack));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        
        else if (skillName == "Gentility")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new DamageReductionEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Arms Shield")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Unit, new DamageReductionEffectt(7));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantExtraDamageEffectt(5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }

        else if (skillName == "Bushido")
        {
           effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantExtraDamageEffectt(7));
           conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefBonusEffectt(6));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResBonusEffectt(3));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.5, AttackType.FirstAttack));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(7));
            effectsByUnitType.AddEffect(UnitRole.Unit, new SpdBonusEffectt(7));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.3, AttackType.FirstAttack));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Fierce Stance")
        {
            conditions.Add(new FirstAttackCondition(UnitRole.Rival));
            effectsByUnitType.AddEffect(UnitRole.Unit, new AtkBonusEffectt(8));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.1, AttackType.FollowUp));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.5));
            effectsByUnitType.AddEffect(UnitRole.Unit, new BonusNeutralizationEffectt(new EnumList<StatType>(new List<StatType> { StatType.Def, StatType.Res })));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DefPercentagePenaltyEffectt(0.5));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ResPercentagePenaltyEffectt(0.5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Chivalry")
        {
            conditions.Add(new HpPercentageCondition(1.0, UnitRole.Rival));
            conditions.Add(new FirstAttackCondition(UnitRole.Unit));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantExtraDamageEffectt(2));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DamageReductionEffectt(2));
            conditionEvaluator = new AndConditionEvaluator(conditions); 
        }
        
        else if (skillName == "Dragon's Wrath")
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.25, AttackType.FirstAttack));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(4));
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(4));
            effectsByUnitType.AddEffect(UnitRole.Unit, new GuardBearingEffectt());
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
        ...
        else if (skillName == "Divine Recreation")
        {
            ...
            effectsByUnitType.AddEffect(UnitRole.Rival, new SpdPenaltyEffectt(4));
            effectsByUnitType.AddEffect(UnitRole.Rival, new DefPenaltyEffectt(4));
            effectsByUnitType.AddEffect(UnitRole.Rival, new ResPenaltyEffectt(4));
            effectsByUnitType.AddEffect(UnitRole.Unit, new ConstantPercentageReductionEffectt(0.3, AttackType.FirstAttack));
            effectsByUnitType.AddEffect(UnitRole.Unit, new DivineRecreationEffectt());
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
    ...
    private static Skill CreateSpecialSkill(string skillName, Unit unit)
    {
        ...
        {
            effectsByUnitType.AddEffect(UnitRole.Unit, new PercentageReductionByHpEffectt(0.5));
            conditionEvaluator = new DefaultConditionEvaluator(conditions);
        }
